...
<head>
  ...
  <title>Admin MAHAMERU Store</title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>MAHAMERU STORE</span>
    </a>
...
<?php $vtan=mysqli_query($con,"SELECT * FROM service where jawab='' order by id_service desc ");$mtan=mysqli_num_rows($vtan); ?>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="admin.jpeg" class="user-image" alt="User Image">
              <span class="hidden-xs">MAHAMERU Store</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="admin.jpeg" class="img-circle" alt="User Image">

                <p>
                  MAHAMERU Store - <?php echo $_SESSION['user']; ?>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>MAHAMERU Store - <?php echo $_SESSION['user']; ?></p>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="#">Ramadhan Qoridhatul Alfarizi</a>.</strong> All rights
    reserved.
  </footer>
